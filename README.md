...
![Cmds Manager 1.5.0](docs/cmdsmanager1.5.0.png)
...
- Scroll the tab strip with the mouse wheel or horizontal wheel while hovering
  over it, without changing the active console or moving focus from its text
...
- Interpret ANSI SGR styles including standard, bright, 256-color, and true-color
  output while keeping control sequences out of search, copying, logs, and exports
