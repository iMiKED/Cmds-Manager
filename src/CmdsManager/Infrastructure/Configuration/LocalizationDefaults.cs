    ...
    internal static class LocalizationDefaults
    {
        ...
        private static Dictionary<string, string> BuildRussian()
        {
            return Dictionary(new[]
            {
                ...
                Pair("Common.Close", "Закрыть"), Pair("Main.Add", "Добавить"), Pair("Main.AddFolder", "Добавить папку"), Pair("Main.Edit", "Изменить"),
                ...
                Pair("Main.FilterHint", "Фильтр по папкам, имени, пути и типу"), Pair("Main.Column.ActivityHint", "Индикатор состояния выполнения"), Pair("Main.Column.Name", "Название"),
                ...
                Pair("Main.Context.NewFolder", "Новая папка"), Pair("Main.Context.NewSubfolder", "Новая вложенная папка"),
                Pair("Main.Context.EditFolder", "Изменить папку"), Pair("Main.Context.DeleteFolder", "Удалить папку"),
                ...
                Pair("Main.RunTitle", "Запуск скриптов"), Pair("Main.DeleteTitle", "Удаление записи"), Pair("Main.DeleteFolderTitle", "Удаление папки"),
                ...
                Pair("Main.DeleteFolderConfirm", "Удалить папку «{0}»?\\n\\nЕё вложенные папки и скрипты будут перемещены на один уровень выше. Файлы скриптов удалены не будут."),
                ...
                Pair("Main.ScriptNotFound", "Скрипт «{0}» не найден в конфигурации."), Pair("Main.MoveFailed", "Не удалось переместить элемент."),
                Pair("Main.Folder.Type", "Папка"), Pair("Main.Folder.ScriptCount", "Скриптов: {0}"), Pair("Main.Folder.Empty", "Пусто"),
                ...
                Pair("Script.Folder", "Папка"), Pair("Script.NoFolder", "Без папки"),
                ...
                Pair("Folder.Title.Add", "Новая папка"), Pair("Folder.Title.Edit", "Изменение папки"),
                Pair("Folder.Name", "Название"), Pair("Folder.Icon", "Иконка"), Pair("Folder.Color", "Цвет иконки"),
                Pair("Folder.Preview", "Предпросмотр"), Pair("Folder.NameRequired", "Введите название папки."),
                Pair("Folder.ChooseIcon", "Выбрать иконку папки"), Pair("Folder.Done", "Готово"),
                Pair("Folder.Icon.Folder", "Папка"), Pair("Folder.Icon.Terminal", "Терминал"), Pair("Folder.Icon.Code", "Код"),
                Pair("Folder.Icon.Lightning", "Молния"), Pair("Folder.Icon.Rocket", "Ракета"), Pair("Folder.Icon.Gear", "Настройки"),
                Pair("Folder.Icon.Database", "База данных"), Pair("Folder.Icon.Server", "Сервер"), Pair("Folder.Icon.Globe", "Сеть"), Pair("Folder.Icon.Star", "Звезда"),
                Pair("Folder.Icon.Money", "Деньги"), Pair("Folder.Icon.Book", "Книга"), Pair("Folder.Icon.Graduation", "Обучение"), Pair("Folder.Icon.Pencil", "Карандаш"),
                Pair("Folder.Icon.Music", "Музыка"), Pair("Folder.Icon.Trash", "Корзина"), Pair("Folder.Icon.Scissors", "Ножницы"), Pair("Folder.Icon.Palette", "Палитра"),
                Pair("Folder.Icon.Stethoscope", "Медицина"), Pair("Folder.Icon.Lotus", "Лотос"), Pair("Folder.Icon.Briefcase", "Портфель"), Pair("Folder.Icon.Chart", "Диаграмма"),
                Pair("Folder.Icon.Dumbbell", "Спорт"), Pair("Folder.Icon.Scales", "Весы"), Pair("Folder.Icon.Wrench", "Инструменты"), Pair("Folder.Icon.Paw", "Лапа"),
                Pair("Folder.Icon.Flask", "Лаборатория"), Pair("Folder.Icon.Brain", "Мозг"), Pair("Folder.Icon.Heart", "Сердце"), Pair("Folder.Icon.Gift", "Подарок"),
                ...
                Pair("Console.LaunchBehavior", "Консоль при запуске"),
                Pair("Console.Launch.Inherit", "Глобальная настройка"),
                Pair("Console.Launch.Reuse", "Переиспользовать консоль"),
                Pair("Console.Launch.NewKeepPrevious", "Новая, сохранить прежнюю"),
                Pair("Console.Launch.NewClosePrevious", "Новая, закрыть прежнюю"),
        ...
        private static Dictionary<string, string> BuildEnglish()
        {
            return Dictionary(new[]
            {
                ...
                Pair("Main.Add", "Add"), Pair("Main.AddFolder", "Add folder"), Pair("Main.Edit", "Edit"), Pair("Main.Delete", "Delete"), Pair("Main.Start", "Start"), Pair("Main.Stop", "Stop"),
                Pair("Main.StartAll", "Start all"), Pair("Main.StopAll", "Stop all"), Pair("Main.Reload", "Reload INI"), Pair("Main.Settings", "Settings"),
                Pair("Main.About", "About"), Pair("Main.Exit", "Exit"), Pair("Main.Filter", "Filter:"), Pair("Main.FilterHint", "Filter by folder, name, path, and type"),
                ...
                Pair("Main.Context.NewFolder", "New folder"), Pair("Main.Context.NewSubfolder", "New nested folder"),
                Pair("Main.Context.EditFolder", "Edit folder"), Pair("Main.Context.DeleteFolder", "Delete folder"),
                ...
                Pair("Main.DeleteTitle", "Delete entry"), Pair("Main.DeleteFolderTitle", "Delete folder"), Pair("Main.DeleteRunning", "Stop the script before deleting its entry."),
                ...
                Pair("Main.DeleteFolderConfirm", "Delete the folder “{0}”?\\n\\nIts nested folders and scripts will move up one level. Script files will not be deleted."),
                ...
                Pair("Main.ScriptNotFound", "Script “{0}” was not found in the configuration."), Pair("Main.MoveFailed", "Could not move the item."),
                Pair("Main.Folder.Type", "Folder"), Pair("Main.Folder.ScriptCount", "{0} scripts"), Pair("Main.Folder.Empty", "Empty"),
                ...
                Pair("Script.Tab.General", "General"), Pair("Script.Tab.Launch", "Launch"), Pair("Script.Name", "Name"), Pair("Script.Folder", "Folder"), Pair("Script.NoFolder", "No folder"), Pair("Script.File", "File"), Pair("Script.Enabled", "Entry is enabled"),
                ...
                Pair("Folder.Title.Add", "New folder"), Pair("Folder.Title.Edit", "Edit folder"),
                Pair("Folder.Name", "Name"), Pair("Folder.Icon", "Icon"), Pair("Folder.Color", "Icon color"),
                Pair("Folder.Preview", "Preview"), Pair("Folder.NameRequired", "Enter a folder name."),
                Pair("Folder.ChooseIcon", "Choose folder icon"), Pair("Folder.Done", "Done"),
                Pair("Folder.Icon.Folder", "Folder"), Pair("Folder.Icon.Terminal", "Terminal"), Pair("Folder.Icon.Code", "Code"),
                Pair("Folder.Icon.Lightning", "Lightning"), Pair("Folder.Icon.Rocket", "Rocket"), Pair("Folder.Icon.Gear", "Settings"),
                Pair("Folder.Icon.Database", "Database"), Pair("Folder.Icon.Server", "Server"), Pair("Folder.Icon.Globe", "Network"), Pair("Folder.Icon.Star", "Star"),
                Pair("Folder.Icon.Money", "Money"), Pair("Folder.Icon.Book", "Book"), Pair("Folder.Icon.Graduation", "Education"), Pair("Folder.Icon.Pencil", "Pencil"),
                Pair("Folder.Icon.Music", "Music"), Pair("Folder.Icon.Trash", "Trash"), Pair("Folder.Icon.Scissors", "Scissors"), Pair("Folder.Icon.Palette", "Palette"),
                Pair("Folder.Icon.Stethoscope", "Medicine"), Pair("Folder.Icon.Lotus", "Lotus"), Pair("Folder.Icon.Briefcase", "Briefcase"), Pair("Folder.Icon.Chart", "Chart"),
                Pair("Folder.Icon.Dumbbell", "Fitness"), Pair("Folder.Icon.Scales", "Scales"), Pair("Folder.Icon.Wrench", "Tools"), Pair("Folder.Icon.Paw", "Paw"),
                Pair("Folder.Icon.Flask", "Laboratory"), Pair("Folder.Icon.Brain", "Brain"), Pair("Folder.Icon.Heart", "Heart"), Pair("Folder.Icon.Gift", "Gift"),
                ...
                Pair("Console.LaunchBehavior", "Console on launch"),
                Pair("Console.Launch.Inherit", "Use global setting"),
                Pair("Console.Launch.Reuse", "Reuse previous console"),
                Pair("Console.Launch.NewKeepPrevious", "New console, keep previous"),
                Pair("Console.Launch.NewClosePrevious", "New console, close previous"),
